...
**Main (orchestrator)**
- Tools profile: full.
- Tools deny: group:web, group:email, group:messaging, group:ui.
- Sandbox: off.
- Delegates web/research to researcher, email/messaging to communicator, HA to controller.
...
- Sandbox tools allow: group:web, group:ui, read, memory_search, memory_get, sessions_list, session_status.
- Workspace: rw, network: bridge. Browser: allowHostControl enabled (uses host Browserless CDP). Screenshots save to the main workspace, not the sub-agent directory.
...
- Tools deny: none (all unlisted tools are implicitly denied).
- Sandbox tools allow: group:email, group:messaging, write, read, sessions_list, session_status.
- Workspace: rw, network: bridge.
...
- Tools deny: none (all unlisted tools are implicitly denied).
- Sandbox tools allow: group:ha, mcp, read, sessions_list, session_status.
- Workspace: rw, network: bridge.
...
- Global sandbox tool deny: canvas, nodes, cron, gateway, and all messaging channels
